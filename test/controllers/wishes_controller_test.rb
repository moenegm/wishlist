...
class WishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wish" do
    assert_difference("Wish.count") do
      post wishes_url, params: { wish: { location: @wish.location, price: @wish.price, title: @wish.title } }
    end
  ...
  test "should update wish" do
    patch wish_url(@wish), params: { wish: { location: @wish.location, price: @wish.price, title: @wish.title } }
